...
//processing options and answers
...
//check if data are valid
		if($('#exam_form').parsley().validate())
		{
			$.ajax({
				...
				{
					//display if data sumitted successfully
					if(data.success)
					{
